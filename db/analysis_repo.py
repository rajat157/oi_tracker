...
class AnalysisRepository(BaseRepository):
    ...
    def save_analysis(self, timestamp: datetime, spot_price: float,
        ...
        from database import save_analysis as _legacy
