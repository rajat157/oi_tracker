...
class TestBlueprintRegistration:
    ...
    def test_route_count(self, app):
        ...
        expected_routes = [
            ...
            "/api/trades", "/api/sell-trades", "/api/dessert-trades",
            "/api/momentum-trades", "/api/pa-trades", "/api/scalp-trades",
            "/api/sell-stats", "/api/dessert-stats", "/api/momentum-stats",
            "/api/pa-stats", "/api/scalp-stats",
