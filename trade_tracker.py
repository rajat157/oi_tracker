...
class TradeTracker:
    ...
    def create_setup(self, analysis: dict, timestamp: datetime) -> Optional[int]:
        ...
        # ===== AUTO ORDER PLACEMENT via Kite (DISABLED) =====
        # Order placement disabled — trade setups are tracked and alerts sent,
        # but no orders are placed on Kite. Re-enable by uncommenting below.
        #
        # try:
        ...
        log.info("Auto order placement disabled - manual order needed")
